...
public class MovimentacaoServiceTest {
  ...
  @Test
  void transferirValores_lancaExcecaoNotFoundException_quandoIdContasInexistentes() {
    final double VALOR = 1000;

    Optional<Conta> contaOrigem = Optional.empty();
    Optional<Conta> contaDestino = Optional.empty();
  ...
  @Test
  void transferirValores_lancaExcecaoNotFoundException_quandoValorMenorQue0() {
  ...
  @Test
  void transferirValores_lancaExcecaoNotFoundException_quandoValorMenorQue0EContasInexistentes() {
    final double VALOR = -1;
